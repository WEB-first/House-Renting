          ...
          <div class="articleItem">
            ...
            <div class="article-wrapper">
              ...
              <div class="article-tag">
                <mt-badge type="success" size="small" style="margin:0 3px">合租</mt-badge>
                <mt-badge type="success" size="small" style="margin:0 3px">朝南</mt-badge>
                <mt-badge type="success" size="small" style="margin:0 3px">近地铁</mt-badge>
                <mt-badge type="success" size="small" style="margin:0 3px">有电梯</mt-badge>
              </div>
              <!-- 价格 -->
